...
export const navBarConfig: NavBarConfig = {
	links: [
		...
		{
			name: "GitHub",
			url: "https://github.com/ingilying", // Internal links should not include the base path, as it is automatically added
...
export const profileConfig: ProfileConfig = {
	...
	name: "Ingil Ying",
	bio: "The sence of life is made by yourself.",
	links: [
		{
			name: "Steam",
		...
		},
		{
			...
			url: "https://github.com/ingilying",
		},
	],
};
